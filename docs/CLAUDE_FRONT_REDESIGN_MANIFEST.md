...
1. `docs/CLAUDE_FRONT_REDESIGN_MANIFEST.md` — présent contrat de mission ;
2. `docs/CLAUDE_FRONT_REDESIGN_HANDOFF.md` — contexte produit, inventaire des 27 écrans et copie du code/CSS actuel ;
...
- Aucun redesign ne doit dépendre de Firebase, Cloud Run ou de la future migration VPS.

...
export default function OperationsPage() {
  ...
  return <section className="view workspace-view operations-command-view">
    <PageHeading eyebrow="Automatisation" title="Cockpit des opérations" subtitle="Tous les workflows automatisés, leur progression et les interventions requises." actions={<><DataSourceBadge label="POSTGRES"/><Link className="secondary-btn" to="/operations/incidents">Incidents · {totals.openIncidents}</Link></>} tabs={<PageTabs items={[{ label: "Cockpit", to: "/operations", end: true }, { label: "Files GPT", to: "/operations/claim-lanes" }, { label: "Exécution", to: "/operations/execution" }, { label: "Observabilité", to: "/operations/observability" }, { label: "Incidents", to: "/operations/incidents" }, { label: "Notifications", to: "/operations/notifications" }, { label: "Runbooks", to: "/operations/runbooks" }]}/>}/>

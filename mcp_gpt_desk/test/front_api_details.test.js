...
test("OpenAPI publishes every current BFF route with resolvable component references", () => {
  ...
  const expectedPaths = [
    ...
    "/execution/overview", "/execution/intents/{intentId}", "/execution/actions",
    "/execution/bridge/heartbeat", "/execution/bridge/claim", "/execution/bridge/complete",
    "/execution/bridge/events", "/execution/bridge/reconcile",
    "/execution/addon/heartbeat", "/execution/addon/claim", "/execution/addon/complete",
    "/execution/addon/events", "/execution/addon/snapshot",

...
import { bootstrapDemoPaperAutonomousResearch } from "../src/research/demo-paper-autonomous-bootstrap.js";

const store = createDeskStoreFromEnv();

try {
  await store.persistence.initialized;
  const result = await bootstrapDemoPaperAutonomousResearch({
    store,

# DeskMonitorCommandContract — v1.1.0

## 1. Objet

Ce contrat décrit les intentions orthogonales émises par un Monitor GPT. Le schéma normatif est `schemas/entities/monitor-command-v1-1.schema.json`.
...
Les versions épinglées sont Monitor V2.1, Monitor Command V1.1, Execution Policy V4.1 et Condition Catalog V1.1.

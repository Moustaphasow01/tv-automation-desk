# DeskExecutionPlanContract — v1.0.0

## 1. Statut et portée

Ce contrat définit la proposition d’exécution structurée produite par le Master GPT **avant** compilation déterministe. Le schéma normatif est `schemas/entities/execution-plan-v1.schema.json`.
...
- contextes épinglés : Master V5, Plan V1, Policy V4, Catalog V1.

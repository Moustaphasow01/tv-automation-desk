# DeskMonitorCommandContract — v1.3.0

## 1. Objet

Ce contrat décrit les intentions orthogonales émises par un Monitor GPT. Le schéma normatif est `schemas/entities/monitor-command-v1-3.schema.json`.
...
Les versions épinglées sont Monitor V2.3, Monitor Command V1.3, Execution Policy V4.2 et Condition Catalog V1.2.

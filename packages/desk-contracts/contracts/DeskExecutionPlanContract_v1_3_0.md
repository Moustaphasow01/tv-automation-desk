# DeskExecutionPlanContract — v1.3.0

## 1. Statut et portée

Ce contrat définit la proposition d’exécution structurée produite par le Master GPT **avant** compilation déterministe. Le schéma normatif est `schemas/entities/execution-plan-v1-3.schema.json`.
...
- contextes épinglés : Master V5.3, Plan V1.3, Policy V4.2, Catalog V1.2.

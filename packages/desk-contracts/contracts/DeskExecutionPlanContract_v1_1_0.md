# DeskExecutionPlanContract — v1.1.0

## 1. Statut et portée

Ce contrat définit la proposition d’exécution structurée produite par le Master GPT **avant** compilation déterministe. Le schéma normatif est `schemas/entities/execution-plan-v1-1.schema.json`.

- `contract.name` : `DeskExecutionPlanContract`
- `contract.version` : `1.1.0`
- profil : `OPPORTUNITY_SEEKING_CONTROLLED`
- catalogue : `condition_catalog_v1_1`
...
- contextes épinglés : Master V5.1, Plan V1.1, Policy V4.1, Catalog V1.1.

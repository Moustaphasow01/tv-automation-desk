# DeskConditionCatalogContract — v1.1.0

## 1. Source normative

Le catalogue machine est `catalogs/condition-catalog-v1-1.json`; son schéma est `schemas/entities/condition-catalog-v1-1.schema.json`. Le JSON, et non le texte libre d’un analyste, définit les prédicats exécutables.

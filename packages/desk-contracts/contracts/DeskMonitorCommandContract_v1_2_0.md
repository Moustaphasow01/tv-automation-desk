# DeskMonitorCommandContract — v1.2.0

## 1. Objet

Ce contrat décrit les intentions orthogonales émises par un Monitor GPT. Le schéma normatif est `schemas/entities/monitor-command-v1-2.schema.json`.
...
Les versions épinglées sont Monitor V2.2, Monitor Command V1.2, Execution Policy V4.2 et Condition Catalog V1.2.

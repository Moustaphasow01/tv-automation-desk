...
export function useWorkspaceMarket(instrument: string, timeframe: string) {
  const query = useFrontView("live-trading", { instrument, timeframe }, { queryScope: "market-series", refetchInterval: 30_000 });

...
export function HumanGatePanel({ humanGate }: { humanGate: CommandCenterView["humanGate"] }) {
  return (
    <CommandPanel code="A" title="OrderIntent & Human Gate" className="cc-panel--human" action={<Link to="/orders">Voir tout</Link>}>
      {humanGate.rows.length ? <div className="cc-table-scroll"><table className="cc-table"><thead><tr><th>OrderIntent ID</th><th>Instrument</th><th>Sens</th><th>Qté</th><th>Mode exéc.</th><th>Human Gate</th><th>Actions autorisées</th><th>Âge</th></tr></thead>

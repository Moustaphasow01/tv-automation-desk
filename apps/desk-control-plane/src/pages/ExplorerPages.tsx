...
export function ResearchExperimentsPage() { return <ExplorerPage viewName="research-experiments" title="Expériences" description="Hypothèses, progression, évaluations et accès aux runs." backTo="/research" backLabel="Laboratoire de recherche" />; }
...
export function PerformanceTradesPage() { return <ExplorerPage viewName="performance-trades" title="Historique des trades" description="Liste des trades utilisés par l'agrégation officielle." backTo="/performance" backLabel="Performance" />; }
export function WorkflowDetailPage() { const { workflowId } = useParams(); return <ExplorerPage viewName="workflow-detail" title="Détail workflow" description="Étapes, progression et résultat du workflow." backTo="/operations" backLabel="Centre d'opérations" params={{ workflowId }} />; }
...
export function OperationsRunbooksPage() { return <ExplorerPage viewName="operations-runbooks" title="Runbooks" description="Procédures et étapes de reprise issues des anomalies réelles." backTo="/operations" backLabel="Centre d'opérations" />; }
...
export function GovernancePoliciesPage() { return <ExplorerPage viewName="governance-policies" title="Politiques" description="Politiques publiées par execution et observabilité." backTo="/settings" backLabel="Réglages" />; }
